...
const ContactPage = () => {
  ...
  function handleSubmit(e) {
    ...
    const url = `https://wa.me/03430915393?text=${encodeURIComponent(text)}`;
      ...
      <div className={contactPageStyles.gridContainer}>
        <div className={contactPageStyles.formContainer}>
            ...
            <p className={contactPageStyles.formSubtitle}>
                Fill the from - we'll open WhatsApp so you can connect with us instantly.
            </p>
            ...
            <div>
                ...
                onChange={handleChange} className={contactPageStyles.input}>
                    <option>
                        Select Service (or chooose Department above)
                    </option>
            ...
            <div>
                ...
                rows={4} className={contactPageStyles.textarea}></textarea>
                {errors.message && (
        ...
        <div className={contactPageStyles.infoContainer}>
            ...
            <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d107384.45330364962!2d73.41160356555135!3d32.58578644598926!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x391f868ad549303d%3A0xb35ecfec8a29a50d!2sMandi%20Bahauddin%2C%20Punjab%2C%20Pakistan!5e0!3m2!1sen!2s!4v1710000000000!5m2!1sen!2s"
            className={contactPageStyles.map}
            title="Mandi Bahauddin Map"
            loading="lazy"
            allowFullScreen
            ></iframe>
