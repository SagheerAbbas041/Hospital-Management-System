...
import { Stethoscope, Phone, Mail, MapPin, ArrowRight, Send } from 'lucide-react';
      ...
      <div className={footerStyles.mainContent}>
        <div className={footerStyles.gridContainer}>
            ...
            <p className={footerStyles.companyDescription}>
                Your trusted partner is healthcare innovation. We're committed
                to providing exceptional medinal care with cutting-edge technology
            ...
            <div className={footerStyles.contactContainer}>
                <div className={footerStyles.contactItem}>
                    ...
                    <span className={footerStyles.contactText}>+92 343-0915393</span>
                </div>
                 ...
                 <div className={footerStyles.contactItem}>
                    ...
                    <span className={footerStyles.contactText}>sagheerabbas700@gmail.com</span>
                </div>
                 ...
                 <div className={footerStyles.contactItem}>
                    ...
                    <span className={footerStyles.contactText}>Punjab, Pakistan</span>
                </div>
            </div>
            </div>
    ...
    <div className={footerStyles.socialContainer}>
      ...
      <div className={footerStyles.bottomSection}>
        ...
        <div className={footerStyles.designerText}>
            ...
            <a target='_blank' href='https://sagheer-abbas-portfolio.vercel.app/'
