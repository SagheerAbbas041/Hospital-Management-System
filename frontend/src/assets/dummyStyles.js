...
export const navbarStylesDr = {
  // Main navbar
  navContainer: "mx-auto my-4 w-full md:max-w-2xl lg:max-w-4xl px-4 py-0 rounded-full bg-white/80 backdrop-blur-md border border-emerald-100 shadow-2xl flex items-center justify-between gap-3 font-serif transition-all duration-300 hover:shadow-emerald-200/80",
  // Left brand section
