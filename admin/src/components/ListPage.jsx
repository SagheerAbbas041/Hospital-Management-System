...
// Helper Function
// this function will give you outputas DD -MM -YYYY;
...
// it will normalize any dat-like stri
...
// this function willl normalize schedule map: ex - 'YYYY_MM_DD' [slot1, slot2,...];
...
// this will be give the coming date first
...
const ListPage = () => {
  ...
  // to fetch the dector that is coming from the server side
  ...
  // shows all doctor or the filter ones
    ...
    <main className={doctorListStyles.gridContainer}>
                      ...
                      <div className={doctorListStyles.statsContainer}>
                          ...
                          <div className={doctorListStyles.actionContainer}>
                              <div className="flex items-center gap-2">
                                  <button onClick={() => removeDoctor(id)} 
          ...
          {filtered.length > 6 &&(
            <div className={doctorListStyles.showMoreContainer}>
                ...
                {showAll ? "Show Less" : `Show more (${filtered.lenght - 4})`}
                </button>
            </div>
          )}
    </main>
