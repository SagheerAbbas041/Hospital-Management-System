...
// Helper Function
// this function will give output in minuts and according to that it will manage am : pm
...
// this function will convrt (YYYY-MM-DD) to Date month year
...
const AddPage = () => {
  ...
  async function handleAdd(e) {
    ...
    try {
      ...
      const API_BASE = "https://hospital-management-system-alpha-lime.vercel.app/api";
  ...
  return (
    ...
    <div className={s.maxWidthContainer + " " + s.formContainer}>
        ...
        <div className={s.submitButtonContainer}>
              ...
              + s.cursorPointer + " " +  (loading ? s.submitButtonDisabled : s.submitButtonEnabled)}>
