...
const AppointmentsPage = () => {
  ...
  const isAdmin = true; // check as the admin is logged in and it major admin for response send by him.
   ...
   async function adminCancelAppointment(id) {
    ...
    try {
      ...
      try {
        ...
        // ignore any error if occur will be hear
      }
    }
  }
      ...
      <div className={pageStyles.maxWidthContainer}>
        <header className={pageStyles.headerContainer}>
          ...
          <div className={pageStyles.headerControlsSection}>
            <div className="flex flex-col md:flex-col sm:flex-row items-center 
            gap-3 w-full sm:w-auto ">
                ...
                <div className={pageStyles.filterContainer}>
                    ...
                    <select className={pageStyles.selectFilter} value={filterSpeciality}
        ...
        {sortedFiltered.length > 8 && (
            <div className="flex justify-center mt-4">
                ...
                className={pageStyles.showMoreButton}>
                    {showAll ? "Show Less" : `Show more (${sortedFiltered.lenght - 8})`}
                </button>
            </div>
        )}
