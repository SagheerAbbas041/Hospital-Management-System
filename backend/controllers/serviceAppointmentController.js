...
// Removed apiVersion so Stripe uses your account's default supported version
...
// this function will parse the time and reture AM : PM
...
// this function will get the user from clerk and reture the user details
...
export const updateServiceAppointment = async (req, res) => {
    ...
    // first check wheather fill if yes ten update the filed
